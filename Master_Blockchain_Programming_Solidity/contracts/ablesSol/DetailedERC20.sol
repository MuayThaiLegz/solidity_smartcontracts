...
// We copy and paste some dependecies to ease the following section.
...
// Creating mintable tokens using ERC20Mintable.sol 

contract ERC20Mintable is ERC20, MinterRole {
    function mint(address to, uint256 value) public onlyMinter returns
    (bool) {
        _mint(to, value);
        return true;
...
// Allow token burning using ERC20Burable.sol
...
Create pauseble tokens using ERC20Pausable.sol: When we need controlled transfer of tokens. 
Use the ERC20Pausable.sol.
Gives owner of the contract the right to pause or unpause token transfers and approvals.
